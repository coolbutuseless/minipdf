...
```{r echo = FALSE}
system("magick -density 300 man/figures/helloworld.pdf -resize 100% -define png:exclude-chunks=date,time man/figures/helloworld.png")
...
```{r echo = FALSE}
system("magick -density 300 man/figures/diamonds.pdf -resize 100% -define png:exclude-chunks=date,time man/figures/diamonds.png")
