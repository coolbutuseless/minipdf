...
```{r include = FALSE}
system("magick -density 300 figures/example0a.pdf -resize 100% -define png:exclude-chunks=date,time figures/example0a.png")
```
...
```{r include = FALSE}
system("magick -density 300 figures/example0b.pdf -resize 100% -define png:exclude-chunks=date,time figures/example0b.png")
```
...
```{r include = FALSE}
system("magick -density 300 figures/example0c.pdf -resize 100% -define png:exclude-chunks=date,time figures/example0c.png")
```
